...
/** DAVID CODE BEGIN **/
  // We promote static variables only when this option is not turned on.
  if (!IPA_Disable_Statics_Promotion) _sym->Promote_Statics();
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
      // Let's copy the ST_ATTR unconditionally.
      ST_ATTR_Init(new_attr, ST_st_idx(cloned_ST), *old_attr);
/*** DAVID CODE END ***/
    }
}

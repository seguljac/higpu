...
/*****************************************************************************
 * 
 * The data structure used here (no longer private to cond.cxx) is a
 ...
 * that the same values are being reused. If that condition might not be true,
 * we discard all equations involving that symbol.
 *
 ****************************************************************************/
...
public:
    ...
    /* All info known about the bounds, including outer loops and
     * conditionals.
     */

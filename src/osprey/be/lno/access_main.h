...
//		are too messy are expessed in terms of promoted bounds.  
//
...
//
//	void Hoist_Iload_Ldid_Upper_Bound_One_Level(WN* loop, BOOL
//	        negative_stride)
//
//		If bounds 'loop' has ILOAD-LDID from lego-tiling, put it into a temp
//		and recompute the access vectors in terms of the new temp value. 
//
//	void Hoist_Varying_Lower_Bounds(WN* func_nd)
//
//		Put any loop lower bound which is assigned in its loop into a preg and

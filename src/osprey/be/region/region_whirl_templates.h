...
// $Author: marcel $
// $Source: /proj/osprey/CVS/open64/osprey1.0/be/region/region_whirl_templates.h,v $
//
// Revision history:
...
/** DAVID CODE BEGIN **/
        // We allow XPRAGMA here.
        Is_True(WN_opcode(x) == OPC_PRAGMA || WN_opcode(x) == OPC_XPRAGMA,
/*** DAVID CODE END ***/
                ("comp_same_pragma, not a pragma"));
        return (WN_pragma(x) == _pragma) ? TRUE : FALSE;
    }
};

...
/** DAVID CODE BEGIN **/
#define CONTEXT_COMPLETE_TY2C   0x000000008     /* Emit complete C type  */
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
#define CONTEXT_complete_ty2c(c) ((c).flags & CONTEXT_COMPLETE_TY2C)
#define CONTEXT_set_complete_ty2c(c) \
   ((c).flags = (c).flags | CONTEXT_COMPLETE_TY2C)
#define CONTEXT_reset_complete_ty2c(c) \
   ((c).flags = (c).flags & ~CONTEXT_COMPLETE_TY2C)
/*** DAVID CODE END ***/

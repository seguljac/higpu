...
enum W2FC_FLAGS {
    ...
    W2FC_TY_IS_USED = 0x04      // TY will appear in the code (complete or
                                // incomplete)
};
/*** DAVID CODE END ***/
...
{
    W2fc_ty_tab->Set_w2fc_flag(TY_IDX_index(ty_idx), W2FC_TY_IS_USED);
}

extern void Reset_TY_is_used(const TY_IDX ty_idx)
{
    W2fc_ty_tab->Reset_w2fc_flag(TY_IDX_index(ty_idx), W2FC_TY_IS_USED);
}

extern BOOL TY_is_used(const TY_IDX ty_idx)
{
    return W2fc_ty_tab->Check_w2fc_flag(TY_IDX_index(ty_idx),
            W2FC_TY_IS_USED);
}

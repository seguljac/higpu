 ...
 * $Author: marcel $
 * $Source: /proj/osprey/CVS/open64/osprey1.0/be/whirl2c/wn2c.h,v $
 *
 * Revision history:
...
/*****************************************************************************
 *
 * Define file-scope CUDA symbols, such as constant/shared memory variables
 * and kernel prototype.
 *
 * We must define them separately because they must be outside the scope of
 * extern "C".
 *
 ****************************************************************************/

extern STATUS WN2C_translate_cuda_defs(CONTEXT context);

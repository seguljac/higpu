...
INT CG_BROWSER::Print_Projected_Node(char* cp, INT cc, PROJECTED_NODE* pn)
{
...
INT CG_BROWSER::Print_Projected_Array(char* cp, INT cc, PROJECTED_ARRAY *pa)
{
...
INT CG_BROWSER::Print_Projected_Region(char* cp, INT cc, PROJECTED_REGION *pr)
{ 

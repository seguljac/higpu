...
/*****************************************************************************
 *
 * Perform scalar EUSE and KILL analysis.
 *
 * DAVID COMMENT: is this class ever used?
 *
 ****************************************************************************/
...
public:
    ...
    IPA_SCALAR_MUST_DF_FLOW(IPA_CALL_GRAPH *cg,
            DF_DIRECTION ddf, MEM_POOL *m);
...
/*****************************************************************************
 *
 * Perform array MOD/REF analysis.
 *
 ****************************************************************************/
...
public:
    ...
    IPA_FORMALS_IN_ARRAY_SECTION_DF(IPA_CALL_GRAPH* cg, DF_DIRECTION ddf,
            MEM_POOL* m);

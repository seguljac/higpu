...
/** DAVID CODE BEGIN **/
#include "config_debug.h"       // for DEBUG_Verbose_hiCUDA
/*** DAVID CODE END ***/
#define IN_ERRORS_C
#include "errors.h"
#undef IN_ERRORS_C
...
extern void DevWarn(const char *fmt, ...)
{
    va_list args;

    va_start ( args, fmt );

    const char *phase_name = (Current_Phase != NULL) ?
        Current_Phase : "unknown phase";

/** DAVID CODE BEGIN **/
    if (DEBUG_Verbose_hiCUDA && dev_warn_enabled)
/*** DAVID CODE END ***/
    {
        /* Write to standard error first: */

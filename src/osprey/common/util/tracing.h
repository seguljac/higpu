...
/* predefined masks for TKIND_DEBUG cases: */
#define TDEBUG_HICUDA 1024
 ...
 *
 * If <append> is TRUE, the new trace file is opened in append mode.
 */
extern void Set_Trace_File(char *filename, BOOL append);

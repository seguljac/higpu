...
// When cloning a procedure, PU-scoped static variables must be promoted to
// file-scoped static variables. However, this messes up the static variable
// declaration generated by the hiCUDA compiler. Let's offer an option to
// disable it, while the hiCUDA compiler guarantees not to use the incorrectly
// cloned static variable.
//
extern BOOL IPA_Disable_Statics_Promotion;
...
// a WHIRL file that contains all symbols in the standard header files

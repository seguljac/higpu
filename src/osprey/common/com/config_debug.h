...
/** DAVID CODE BEGIN **/
   ...
   */
  INT32 buffer[14];		/* Buffer space -- initialize to FALSE */
/*** DAVID CODE END ***/
} DEBUG_FLAGS;

/* ====================================================================
...
#endif
/** DAVID CODE BEGIN **/
#define DEBUG_Verbose_hiCUDA		(Current_DEBUG->verbose_hicuda)
#define DEBUG_Verbose_hiCUDA_Set	(Current_DEBUG->verbose_hicuda_set)
/*** DAVID CODE END ***/

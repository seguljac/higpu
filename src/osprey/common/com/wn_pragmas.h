...
/** DAVID CODE BEGIN **/
    ...
    // global directive
    WN_PRAGMA_HC_GLOBAL_COPYIN,
    WN_PRAGMA_HC_GLOBAL_COPYOUT,
    WN_PRAGMA_HC_GLOBAL_FREE,
    WN_PRAGMA_HC_DECL,
    WN_PRAGMA_HC_COPY,
    // shared directive
    WN_PRAGMA_HC_SHARED_COPYIN,
    WN_PRAGMA_HC_SHARED_COPYOUT,
    WN_PRAGMA_HC_SHARED_REMOVE,
    // const directive
    WN_PRAGMA_HC_CONST_COPYIN,
    WN_PRAGMA_HC_CONST_REMOVE,
    // shape directive
    WN_PRAGMA_HC_SHAPE,
    // barrier directive
    WN_PRAGMA_HC_BARRIER,
    // kernel directive
    WN_PRAGMA_HC_KERNEL,
    WN_PRAGMA_HC_KERNEL_BLK_SPACE,
    WN_PRAGMA_HC_KERNEL_THR_SPACE,
    // kernel partition directive
    WN_PRAGMA_HC_KERNEL_PART,
    // loopblock directive
    WN_PRAGMA_HC_LOOPBLOCK,
/*** DAVID CODE END ***/

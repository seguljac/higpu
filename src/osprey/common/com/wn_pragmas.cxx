...
/** DAVID CODE BEGIN **/
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_GLOBAL_COPYIN" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_GLOBAL_COPYOUT" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_GLOBAL_FREE" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_DECL" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_COPY" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_SHARED_COPYIN" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_SHARED_COPYOUT" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_SHARED_REMOVE" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_CONST_COPYIN" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_CONST_REMOVE" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_SHAPE" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_BARRIER" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_KERNEL" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_KERNEL_BLK_SPACE" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_KERNEL_THR_SPACE" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_KERNEL_PART" },
    { PUSER_HICUDA, WN_PRAGMA_SCOPE_POINT, "HC_LOOPBLOCK" },
/*** DAVID CODE END ***/

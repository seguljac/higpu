...
extern WN_MAP_TAB *WN_MAP_TAB_Create(struct mem_pool *pool);

extern void WN_MAP_TAB_Delete(WN_MAP_TAB *maptab);

#define WN_MAP_TAB_Last_ID(maptab,category) \
    (maptab)->_last_map_id[(category)]


extern WN_MAP WN_MAP_Do_Create(WN_MAP_TAB *maptab, struct mem_pool *pool,
        WN_MAP_KIND kind);
...
extern WN_MAP_ID IPA_WN_MAP_Status(WN_MAP_TAB *maptab);

#define WN_MAP_Status() IPA_WN_MAP_Status(Current_Map_Tab)

extern void IPA_WN_MAP_Delete(WN_MAP_TAB *maptab, WN_MAP wn_map);

#define WN_MAP_Delete(wn_map) IPA_WN_MAP_Delete(Current_Map_Tab, (wn_map))


extern void IPA_WN_MAP_Set(WN_MAP_TAB *maptab, WN_MAP wn_map,
        WN *wn, void *thing);
extern void IPA_WN_MAP32_Set(WN_MAP_TAB *maptab, WN_MAP wn_map,
        WN *wn, INT32 thing);
extern void IPA_WN_MAP64_Set(WN_MAP_TAB  *maptab, WN_MAP wn_map,
        WN *wn, INT64 thing);
...
extern void *IPA_WN_MAP_Get(WN_MAP_TAB *maptab, WN_MAP wn_map, const WN *wn);
extern INT32 IPA_WN_MAP32_Get(WN_MAP_TAB *maptab, WN_MAP wn_map, const WN *wn);
extern INT64 IPA_WN_MAP64_Get(WN_MAP_TAB *maptab, WN_MAP wn_map, const WN *wn);
...
extern void WN_MAP_Add_Free_List(WN_MAP_TAB *maptab, WN *wn);

extern void WN_MAP_Set_ID(WN_MAP_TAB *maptab, WN *wn);

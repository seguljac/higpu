...
/** DAVID CODE BEGIN **/
enum LABEL_FLAGS {
    LABEL_TARGET_OF_GOTO_OUTER_BLOCK = 0x000001,
    LABEL_ADDR_SAVED = 0x000002,
    LABEL_ADDR_PASSED = 0x000004,
    LABEL_IS_NOT_USED = 0x000008    // not referenced in the PU
};
/*** DAVID CODE END ***/
...
enum ST_ATTR_KIND {
    ST_ATTR_UNKNOWN,
    ST_ATTR_DEDICATED_REGISTER,     // physical register number
    ST_ATTR_SECTION_NAME,           // name of sections where defined.
    ST_ATTR_EXTRA_FLAGS             // CUDA-related flags
};

// extra flags (32-bit)
#define ST_ATTR_IS_CUDA_RUNTIME     0x00000001  // functions or builtin vars
#define ST_ATTR_IS_SHARED_VAR       0x00000002
#define ST_ATTR_IS_GLOBAL_VAR       0x00000004
#define ST_ATTR_IS_CONST_VAR        0x00000008
#define ST_ATTR_IS_KERNEL           0x00000010
#define ST_ATTR_IS_DEVICE           0x00000020  // device function
// associated with the (base) variables that appear in hiCUDA data directives
#define ST_ATTR_IS_HICUDA_DATA      0x00000040
...
public:
    ...
    void Set_u(UINT64 val) { u.section_name = val; }

    // Access reg_id
    void Set_reg_id(mPREG_NUM r) { u.reg_id = r; }

    mPREG_NUM Get_reg_id(void) const { return u.reg_id; }

    // Access section_name
    void Set_section_name(STR_IDX i) { u.section_name = i; }

    STR_IDX Get_section_name(void) const { return u.section_name; }

    // Access flags
    void Set_flags(mUINT32 flags) { u.value = flags; }

    mUINT32 Get_flags(void) const { return u.value; }
...
/** DAVID CODE BEGIN **/
enum TY_SCALAR_FLAGS {
    TY_IS_ENUM = 0x00000001,        /* the type is an enumeration */
    /* The type is long int, of arch-dependent size.
     * We need this for correct code generation. */
    TY_IS_LONG_INT = 0x00000002,
    /* The type is char, which is different from signed/unsigned char. */
    TY_IS_CHAR = 0x00000004
};
/*** DAVID CODE END ***/
...
public:
    ...
    union {
	    ...
	    ARB_IDX arb;
/** DAVID CODE BEGIN **/
        EELIST_IDX eelist;  // enum entry list
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
    mUINT32 scalar_flags;       // extra flags for KIND_SCALAR
/*** DAVID CODE END ***/
#ifdef KEY
...
/** DAVID CODE BEGIN **/
    EELIST_IDX EElist() const { return u1.eelist; }
    void Set_eelist(EELIST_IDX idx)	{ u1.eelist = idx; }
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
    mUINT32 Scalar_flags() const { return u2.scalar_flags; }
    void Set_scalar_flag(TY_SCALAR_FLAGS f) { u2.scalar_flags |= f; }
    void Clear_scalar_flag(TY_SCALAR_FLAGS f) { u2.scalar_flags &= ~f; }
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
#define PU_IS_KERNEL    0x0000200000000000LL    // PU is a CUDA kernel function
#define PU_IS_DEVICE    0x0000400000000000LL    // PU is a CUDA device function
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
typedef SEGMENTED_ARRAY<EELIST> EELIST_TAB;
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
extern EELIST_TAB	EElist_Table;
/*** DAVID CODE END ***/
...
/** DAVID CODE BEGIN **/
#define GLOBAL_SYMTAB_TABLES	(14)	// # of tables in global symtab:
					// FILE_INFO, ST, TY, PU, FLD, ARB,
					// TYLIST, EELIST, TCON, STR, INITO, INITV,
					// BLK, and ST_ATTR
/*** DAVID CODE END ***/

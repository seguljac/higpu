...
// Is hiCUDA enabled?
int flag_hicuda = 0;
// Is debugging hiCUDA enabled?
int flag_debug_hicuda = 0;
// Include all types in the WHIRL binary?
int flag_keep_all_types = 0;
...
/** DAVID CODE BEGIN **/
    ...
    if (strcmp(arg, "vhc") == 0)
    {
        // Using a custom option like this is easier than  passing "-td1024"
        // to gfec and then using Process_Trace_Option.
        //
        // We cannot set the trace flags directly here because tracing.h is
        // not supposed to be included here. We use an intermediate flag.
        flag_debug_hicuda = 1;
        return 1;
    }
    if (strcmp(arg, "keep-all-types") == 0)
    {
        flag_keep_all_types = 1;
        return 1;
    }
/*** DAVID CODE END ***/
#endif // KEY

...
/* Put all types in the list 'ty_list' to the type table.
 * This is a hack, called at the end of program parsing in c-parse.y. */
extern void WFE_decl_all_types_and_symbols(tree ty_list, tree st_list);

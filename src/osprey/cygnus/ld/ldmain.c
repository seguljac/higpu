...
#ifdef KEY
  // TODO:  Find out why ipa_link is not respecting weak definitions, such as
  //        memset in libpscrt.  In binutils 2.14, this error message is
  //        emitted only if obfd != NULL.  Do what 2.14 does until we find out
...
#ifndef KEY	// Remove 'deprecated' warning.
      if (! info.found)
	einfo ("%B: %s%s\n", abfd, _("warning: "), warning);
#endif
